...
#define ISP_SHT_SWWRFLIPNUM                 (14 + 16)
#define ISP_SHT_SWWRFLIP_EN                 (13 + 16)
#define ISP_SHT_WRITE_ROTATE_DIR            (10 + 16)
#define ISP_SHT_OUT_TRI_BUFFER_EN           (9 + 16)
#define ISP_SHT_OUT_DUAL_BUFFER_EN          (8 + 16)
#define ISP_SHT_DISABLE_TO_LCD_FLIP_EN      (7 + 16)
