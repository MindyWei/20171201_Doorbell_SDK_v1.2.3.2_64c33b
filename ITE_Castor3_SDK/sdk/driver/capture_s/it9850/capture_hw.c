    ...
    void)
{
	...
	//TODO: change to PLL1Out1 26MHZ MCLK, 0x320/2/15=26
	ithWriteRegMaskH(ITH_SENSOR_CLK_REG, 0x00 << 8 , ITH_SENSOR_CLK_SEL_MASK); //26Mhz
    ithWriteRegMaskH(ITH_SENSOR_CLK_REG, 0x0E, ITH_SENSOR_CLK_RATIO_MASK);  //26Mhz //from PLL1Out1 
}
