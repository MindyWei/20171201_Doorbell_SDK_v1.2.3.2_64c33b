...
static int linphonec_call_check_audio_broadcast_callback_default(void)
{
    return FALSE;
}
int (*linphonec_call_check_audio_broadcast_callback)(void) = linphonec_call_check_audio_broadcast_callback_default;
...
static void call_received(SalOp *h){
    ...
    linphonec_call_check_audio_broadcast_callback();
#endif
