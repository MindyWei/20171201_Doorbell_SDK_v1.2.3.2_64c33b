...
/**
 * Callback when call invited. This is used to determine the behavior after a call is inviting to stop audio broadcast.
 *
 * @return 1 if the application is cstopping failed; 0 is stopping ok.
 */
extern int (*linphonec_call_check_audio_broadcast_callback)(void);
