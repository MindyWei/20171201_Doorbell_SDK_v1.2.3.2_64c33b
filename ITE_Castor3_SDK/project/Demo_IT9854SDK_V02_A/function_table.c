...
extern bool ArcCoverflowOnEnter(ITUWidget* widget, char* param);
extern bool ArcCoverflowOnTimer(ITUWidget* widget, char* param);
...
ITUActionFunction actionFunctions[] =
{
    ...
    "ArcCoverflowOnEnter", ArcCoverflowOnEnter,
    "ArcCoverflowOnTimer", ArcCoverflowOnTimer,
    NULL, NULL
};
