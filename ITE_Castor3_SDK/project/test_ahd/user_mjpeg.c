...
void *__wait_play_over()
{
	...
	if(tidAVIOpen)
	{
		...
		tidAVIOpen = 0;
		printf("end of tidAVIOpen...............\n");
	}
}
bool PlayerStop = false;
bool PlayerStart = false;
bool PlayerRead = true;
void *_user_video_play(void *arg)
{
	while(1)
	{
		usleep(10);
		//printf("---------->wait video play\n");
		if(PlayerRead && PlayerStart)
		{
