...
static ITUBackground* settingNetworkIPAssignBackground;
static ITUBackground* mainTopBackground;
static ITUBackground* settingNetworkIPInputBackground;	
...
static ITUBackground* settingNetworkMacInputBackground;	
...
bool SettingNetworkIPInputNumberButtonOnPress(ITUWidget* widget, char* param)
{
    ...
    if (ituWidgetIsVisible(settingNetworkMacInputBackground))
    {
        ituTextBoxInput(settingNetworkMacInputTextBox, input);
    }
    else if (!ituWidgetIsVisible(settingNetworkIPInputBackground))
        return false;
...
bool SettingNetworkMacInputConfirmButtonOnPress(ITUWidget* widget, char* param)
{
    ...
    ituWidgetSetVisible(settingNetworkMacInputBackground, false);
...
bool SettingNetworkIPInputConfirmButtonOnPress(ITUWidget* widget, char* param)
{
    ...
    else
    {
        ...
        ituWidgetSetVisible(settingNetworkGrayBackground, false);
        ituWidgetSetVisible(settingNetworkIPInputBackground, false);
        ituWidgetEnable(mainTopBackground);
        ituWidgetEnable(settingBackground);
        ituWidgetEnable(settingNetworkBackground);
        return true;
...
static bool SettingNetworkGrayBackgroundUpdate(ITUWidget* widget, ITUEvent ev, int arg1, int arg2, int arg3)
{
    bool result = false;
    assert(widget);
    ...
    if (ev == ITU_EVENT_MOUSEDOWN)
    {
        if (ituWidgetIsEnabled(widget))
        {
            ...
            if (ituWidgetIsInside(widget, x, y))
            {
                ...
                if (ituWidgetIsVisible(settingNetworkIPAssignBackground))
                {
                    ituWidgetGetGlobalPosition(settingNetworkIPAssignBackground, &xx, &yy);
                    w = ituWidgetGetWidth(settingNetworkIPAssignBackground);
                    h = ituWidgetGetHeight(settingNetworkIPAssignBackground);

                    if (x < xx || x > (xx + w) || y < yy || y > (yy + h))
                    {
                        ituWidgetSetVisible(settingNetworkIPAssignBackground, false);
                ...
                {
                    ituWidgetGetGlobalPosition(settingNetworkIPInputBackground, &xx, &yy);
                    w = ituWidgetGetWidth(settingNetworkIPInputBackground);
                    h = ituWidgetGetHeight(settingNetworkIPInputBackground);
                ...
                else if (ituWidgetIsVisible(settingNetworkMacInputBackground))
                {
                    ituWidgetGetGlobalPosition(settingNetworkMacInputBackground, &xx, &yy);
                    w = ituWidgetGetWidth(settingNetworkMacInputBackground);
                    h = ituWidgetGetHeight(settingNetworkMacInputBackground);
...
bool SettingNetworkOnEnter(ITUWidget* widget, char* param)
{
    if (!settingNetworkIPAssignSprite)
    {
        ...
        ituWidgetSetUpdate(settingNetworkGrayBackground, SettingNetworkGrayBackgroundUpdate);
        ...
        settingNetworkIPAssignBackground = ituSceneFindWidget(&theScene, "settingNetworkIPAssignBackground");
        assert(settingNetworkIPAssignBackground);

        mainTopBackground = ituSceneFindWidget(&theScene, "mainTopBackground");
        assert(mainTopBackground);

        settingNetworkIPInputBackground = ituSceneFindWidget(&theScene, "settingNetworkIPInputBackground");
        assert(settingNetworkIPInputBackground);
        ...
        settingNetworkMacInputBackground = ituSceneFindWidget(&theScene, "settingNetworkMacInputBackground");
        assert(settingNetworkMacInputBackground);
